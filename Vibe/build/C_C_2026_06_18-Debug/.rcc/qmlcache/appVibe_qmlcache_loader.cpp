...
Registry::Registry() {
    resourcePathToCachedUnit.insert(QStringLiteral("/qt/qml/Vibe/Main.qml"), &QmlCacheGeneratedCode::_qt_qml_Vibe_Main_qml::unit);
    ...
    resourcePathToCachedUnit.insert(QStringLiteral("/qt/qml/Vibe/DisplayArea.qml"), &QmlCacheGeneratedCode::_qt_qml_Vibe_DisplayArea_qml::unit);
